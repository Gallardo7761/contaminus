 ...
 * 
 * Muestra el mapa de contaminación para un dispositivo específico.
 */
...
const PollutionMapByDeviceContent = () => {
    ...
    return (
        <div className='p-3'>
            <MapContainer center={[37.3886, -5.9823]} zoom={13} scrollWheelZoom={false} style={mapStyles}>
                <TileLayer
...
export default PollutionMapByDevice;
